...
const apiIntegrations = [
  ...
  { id: 'sabre', name: 'Sabre GDS (International Flights)', description: 'World\'s leading GDS for international flights — 400+ airlines, real-time availability, pricing & booking via Bargain Finder Max API', fields: [{ key: 'enabled', label: 'Enabled', placeholder: '', type: 'select', options: ['true', 'false'] }, { key: 'environment', label: 'Environment', placeholder: 'cert', type: 'select', options: ['cert', 'production'] }, { key: 'pcc', label: 'PCC (Pseudo City Code)', placeholder: 'F9CE', type: 'text' }, { key: 'sandbox_client_id', label: 'Cert/Sandbox Client ID', placeholder: 'V1:xxxxxx:DEVCENTER:EXT', type: 'text' }, { key: 'sandbox_client_secret', label: 'Cert/Sandbox Client Secret', placeholder: 'Your sandbox secret', type: 'password' }, { key: 'sandbox_url', label: 'Cert/Sandbox URL', placeholder: 'https://api-crt.cert.havail.sabre.com', type: 'text' }, { key: 'prod_client_id', label: 'Production Client ID', placeholder: 'V1:xxxxxx:DEVCENTER:EXT', type: 'text' }, { key: 'prod_client_secret', label: 'Production Client Secret', placeholder: 'Your production secret', type: 'password' }, { key: 'prod_url', label: 'Production URL', placeholder: 'https://api.sabre.com', type: 'text' }], docs: 'https://developer.sabre.com', category: 'travel' },
