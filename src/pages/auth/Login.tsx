        ...
        <Card className="w-full max-w-md border-0 shadow-none bg-transparent">
          ...
          <CardContent className="pt-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button variant="outline" className="h-11 font-medium" onClick={() => toast({ title: "Coming Soon", description: "Google sign-in will be available soon." })}>
              ...
              <Button variant="outline" className="h-11 font-medium" onClick={() => toast({ title: "Coming Soon", description: "Facebook sign-in will be available soon." })}>
